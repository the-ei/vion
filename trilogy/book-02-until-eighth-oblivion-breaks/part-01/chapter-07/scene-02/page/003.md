...
"That's the thing, Ruth. It doesn't require a single director. It's emergent - lots of small decisions that add up to a pattern, each one defensible in isolation, devastating in aggregate. A thousand actors following incentives, and the result looks like conspiracy without requiring one. The question isn't who ordered it. The question is who benefits from it."
